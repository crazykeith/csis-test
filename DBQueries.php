class DBQueries
{
  protected $num_results = 0;
	...
	protected function selectQuery($sql,$search) {
		...
		* Parameters:
		*   $sql - a string containing the SQL statement customized for whatever purpose.
        *   $search - a keyed array containing all of the named parameters for the SQL statement
		* Sample Usage:
	...
	protected function insertUpdateDeleteQuery($sql,$changes) {
		...
		* Description:
		*   Base function for inserting, updating, or deleting data from the database.
		* Parameters:
		*   $sql - a string containing the SQL statement customized for whatever purpose.
        *   $changes - a keyed array containing all of the named parameters for the SQL statement
		* Sample Usage:
		*   $DB_class = new DBQueries;
